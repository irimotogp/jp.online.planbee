...
class AgencyRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        return [
            ...
            'kanji_sei' => 'nullable|max:255|required_if:sex_type,' . implode(",", array_diff(SexType::ALL_OPTIONS, [SexType::CORPORATION])),
            'kanji_mei' => 'nullable|max:255|required_if:sex_type,' . implode(",", array_diff(SexType::ALL_OPTIONS, [SexType::CORPORATION])),
            'kata_sei' => 'nullable|max:255|regex:/\A[ｦ-ﾟ]+\z/u|required_if:sex_type,' . implode(",", array_diff(SexType::ALL_OPTIONS, [SexType::CORPORATION])),
            'kata_mei' => 'nullable|max:255|regex:/\A[ｦ-ﾟ]+\z/u|required_if:sex_type,' . implode(",", array_diff(SexType::ALL_OPTIONS, [SexType::CORPORATION])),
            'corp_kanji' => 'nullable|max:255|required_if:sex_type,' . SexType::CORPORATION,
            'corp_kata' => 'nullable|max:255|regex:/\A[ｦ-ﾟ()（）]+\z/u|required_if:sex_type,' . SexType::CORPORATION,
            'rep_kanji_sei' => 'nullable|max:255|required_if:sex_type,' . SexType::CORPORATION,
            'rep_kanji_mei' => 'nullable|max:255|required_if:sex_type,' . SexType::CORPORATION,
            'rep_kata_sei' => 'nullable|max:255|regex:/\A[ｦ-ﾟ]+\z/u|required_if:sex_type,' . SexType::CORPORATION,
            'rep_kata_mei' => 'nullable|max:255|regex:/\A[ｦ-ﾟ]+\z/u|required_if:sex_type,' . SexType::CORPORATION,
            ...
            'card_name' => 'required_if:monthly_payment_type,' . MonthlyPaymentType::CREDITCARD . '|required_if:initial_payment_type,' . InitialPaymentType::CREDITCARD . '|nullable|max:255',
            ...
            'bank_name' => $cashback_rule . "|max:255",
            'bank_code' => $cashback_rule . "|max:255",
            'branch_name' => $cashback_rule . "|max:255",
            'branch_code' => $cashback_rule . "|max:255",
            'deposit_id' => $cashback_rule . '|exists:deposits,id',
            'account_number' => $cashback_rule . '|numeric|digits_between:1,7',
            'account_name' => $cashback_rule . '|regex:/\A[ｦ-ﾟ()（） ]+\z/u|max:255',
