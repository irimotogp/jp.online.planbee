...
class CustomerRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        return [
            ...
            'card_name' => 'max:255required_if:monthly_payment_type,' . MonthlyPaymentType::CREDITCARD . '|required_if:initial_payment_type,' . InitialPaymentType::CREDITCARD . '|nullable',
